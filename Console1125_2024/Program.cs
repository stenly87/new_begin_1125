    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            */
            ...
            int someBin = 0b10; // представление двоичного числа 2
            Console.WriteLine(someBin);
            int someHex = 0xFF; // 255 в 16-ричной системе
            Console.WriteLine(someHex);

            // побитовые операции можно использовать для 
            // хранения в одной переменной множества значений (по одному на бит)
            // хранение характеристик или настроек объекта

            // допустим мы хотим сохранить некоторые характеристики бургера
            // допустим в 1 байте 0000 0000 биты будут распределены следующим образом:
            // 1 бит - наличие котлеты
            // 2 бит - наличие сыра
            // 3 бит - наличие лука
            // 4 бит - салат
            // 5 бит - соус
            ...
            // 8 бит - кунжут
            byte burger = 0;
            // кладем в бургер котлету
            // 00000000
            // 00000001
            burger |= 0b1; // burger = 1 вот этой операцией мы затрем все биты
            // кладем в бургер соус
            burger |= 0b10000;
            Console.WriteLine("бургер " + burger);

            // проверяем наличие бита
            bool exist = (burger & 0b10000) == 0b10000;
            Console.WriteLine("В бургере есть соус: " + exist);
            exist = (burger & 0b10) == 0b10;
            Console.WriteLine("В бургере есть сыр: " + exist);

            // убираем соус из бургера
            burger ^= 0b10000;
            exist = (burger & 0b10000) == 0b10000;
            Console.WriteLine("бургер " + burger);
            Console.WriteLine("В бургере есть соус: " + exist);
